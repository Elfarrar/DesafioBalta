...
namespace Identity.Helpers
{
    public class AutenticationHelper : IAutenticationHelper
    {
        ...
        public AutenticationHelper(UserManager<IdentityUser> userManager,
        ...
        public async Task<UserLogged> GenerateJwt(string email)
        {
        ...
        private UserLogged GetToken(string encodedToken, IdentityUser user, IEnumerable<Claim> claims)
        {
